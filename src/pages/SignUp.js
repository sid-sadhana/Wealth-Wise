...
const SignUp = () => {
    ...
    const progress_state = "11"; // Assuming this will be used for the MultiStep component later
        ...
        <div id="bg">
            ...
            <div className="flex justify-center mt-28">
                ...
                <div className="border w-2/4 flex flex-col items-center justify-center">
                    <MultiStep className="w-[95%] bg-transparent border h-1" total="w-[95%] bg-transparent border rounded-full h-1" progress="10" />
                    <Step1/>
